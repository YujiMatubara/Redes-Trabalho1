...
typedef struct _player {
    ...
    card cardsInHand[3];
    // colocar como identificar o socket do player
} player;
...
class Server {
    ...
    public:
        ...
        void startGame() {
            // Passo 1: verificar se 4 players estão conectados ao servidor
            ...
            for (int pIndex = 0; pIndex < NB_PLAYERS; pIndex++) {
                ...
                printf("Jogador <%d> inserido no time %d\n", activePlayers[pIndex].playerName, activePlayers[pIndex].teamID);
            }
            ...
            // Passp 5: chamar função que aguarda input dos jogadores e gerencia o jogo...
        }
